setwd("C:/Users/chens/Desktop/�½��ļ���")
d=temp=read.table(file="191004.txt",sep="\t", header=T, na.strings = "NA",fileEncoding="utf8")
d=temp=read.csv(file="raw data title.csv",header=T, na.strings = "NA",fileEncoding="UTF-8")


t=read.csv(file="raw data title.csv",header=F,encoding="UTF-8")
a=read.csv(file="raw data abstract.csv",header=F,encoding="UTF-8")
temp=read.csv(file="raw data 191005.csv",header=T,encoding="UTF-8")




temp=read.xls(file="test.xlsx",sheet=1,header=T, na.strings = "NA",fileEncoding="utf8")
